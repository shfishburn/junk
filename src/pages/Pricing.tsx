...
const truckLoadPricing = [
  { load: "Minimum Load", description: "A few small items (1-2 pieces)", price: "$245 – $370" },
  { load: "1/8 Truck Load", description: "A couple items like a chair + TV", price: "$370 – $490" },
  { load: "1/4 Truck Load", description: "Small room cleanout or a few furniture pieces", price: "$490 – $735" },
  { load: "1/2 Truck Load", description: "Garage cleanout or bedroom furniture set", price: "$735 – $975" },
  { load: "3/4 Truck Load", description: "Large room or multiple rooms", price: "$975 – $1,220" },
  { load: "Full Truck Load", description: "Whole house or estate cleanout", price: "$1,220 – $1,595" },
];
